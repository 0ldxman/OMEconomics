  ...
  return (
    <div className="flex flex-col gap-6 py-6 w-full mx-auto px-4">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Dialog onOpenChange={(open) => {
            ...
            <DialogContent className="sm:max-w-2xl">
              <DialogHeader>
                <DialogTitle className="text-zinc-100 font-black uppercase tracking-tighter">Закупка и поставка</DialogTitle>
                <DialogDescription className="sr-only">Укажите количество товаров для пополнения склада</DialogDescription>
              </DialogHeader>
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-4xl p-0 overflow-hidden flex flex-col max-h-[90vh] !w-[90vw]">
              <DialogHeader className="p-6 pb-2">
                <DialogTitle className="text-zinc-100 font-black uppercase tracking-tighter">Создание нового товара</DialogTitle>
                <DialogDescription className="sr-only">Настройте базовые параметры и эффекты предмета</DialogDescription>
              </DialogHeader>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="sm:max-w-4xl p-0 overflow-hidden flex flex-col max-h-[90vh] !w-[90vw]">
          <DialogHeader className="p-6 pb-2">
            <DialogTitle className="text-zinc-100 font-black uppercase tracking-tighter">Настройки предмета: {editingItem?.name}</DialogTitle>
            <DialogDescription className="sr-only">Редактирование параметров и поведения предмета</DialogDescription>
          </DialogHeader>
          <div className="flex-1 overflow-y-auto px-6 py-4">
